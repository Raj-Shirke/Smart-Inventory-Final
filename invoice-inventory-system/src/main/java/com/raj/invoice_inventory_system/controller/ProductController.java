...
public class ProductController {
    ...
    @GetMapping("/ai-suggest-price")
public String getAiPrice(@RequestParam int qty, @RequestParam int cat) {
    String pythonUrl = "http://127.0.0.1:5000/predict?qty=" + qty + "&cat=" + cat;
